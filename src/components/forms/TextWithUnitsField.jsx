...
export default class TextWithUnitsField extends React.PureComponent {
    render() {
        ...
        return <Form.Group as={Row}>
                <Form.Label htmlFor={this.props.name} column sm={4} className="text-right font-weight-bold">
                    {this.props.label}
                </Form.Label>
                <InputGroup as={Col} sm={8}>
                    ...
                    <InputGroup.Append>
                        <Form.Control
                            ...
                            {this.props.units.map(this.renderUnitOption)}
                        </Form.Control>
                    </InputGroup.Append>
