...
import { DISTANCE_UNITS, DISTANCE_SQUARED_UNITS, VELOCITY_UNITS, toGees } from '../utils';
        ...
        return <>
                ...
                <DefinitionList>
                    ...
                    <DefinitionList.Item label="Surface Area">
                        <NumberFormat value={this.props.body.surfaceArea} fractionDigits={3} units={DISTANCE_UNITS} exponential />
                    </DefinitionList.Item>

                    <DefinitionList.Item label="Mass">
                        <NumberFormat value={this.props.body.mass} fractionDigits={6} suffix=' kg' exponential />
                    </DefinitionList.Item>
                    ...
                    <DefinitionList.Item label="Rotation Period">
                        <DurationFormat value={this.props.body.rotationalPeriod} calendar={this.props.calendar} includeRaw />
                    </DefinitionList.Item>
