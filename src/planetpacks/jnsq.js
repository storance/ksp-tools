...
const Kerbol = new Body({
    ...
    radius: 175750000,
    geeAsl: 27.7,
    highSpaceAltitude: 3e9,
    rotationalPeriod: 1080000,
    atmosphere: atmosphere(1600000, 500000)
});
...
const Eve = new Body({
    ...
    radius: 2050000,
    geeAsl: 1.4,
    atmosphere: atmosphere(60000, 27000),
    highSpaceAltitude: 1025000,
...
const Kerbin = new Body({
    ...
    radius: 1600000,
    geeAsl: 1,
    atmosphere: atmosphereWithOxygen(85000, 21000),
    highSpaceAltitude: 800000,
...
const Duna = new Body({
    ...
    radius: 800000,
    geeAsl: 0.34,
    atmosphere: atmosphere(70000, 10000),
...
const Jool = new Body({
    ...
    radius: 14000000,
    geeAsl: 1.04,
    atmosphere: atmosphere(700000, 285000),
    highSpaceAltitude: 7000000,
...
const Laythe = new Body({
    ...
    radius: 1100000,
    geeAsl: 0.58,
    atmosphere: atmosphereWithOxygen(75000, 23000),
    highSpaceAltitude: 200000,
    tidallyLocked: true,
    orbit: new Orbit({
        parentBody: Jool,
...
const Tylo = new Body({
    ...
    radius: 900000,
    geeAsl: 0.32, 
    atmosphere: atmosphere(85000, 11000),
    highSpaceAltitude: 450000,
    tidallyLocked: true,
    orbit: new Orbit({
        parentBody: Jool,
...
const Lindor = new Body({
    ...
    radius: 8000000,
    geeAsl: 0.94,
    atmosphere: atmosphere(540000, 230000),
...
const Huygen = new Body({
    ...
    radius: 670000,
    geeAsl: 0.15,
    atmosphere: atmosphere(180000, 75000),
    highSpaceAltitude: 335000,
    tidallyLocked: true,
    orbit: new Orbit({
        parentBody: Lindor,
...
const Riga = new Body({
    ...
    radius: 750000,
    geeAsl: 0.18,
    atmosphere: atmosphere(90000, 10000),
    highSpaceAltitude: 375000,
    tidallyLocked: true,
    orbit: new Orbit({
        parentBody: Lindor,
...
const Eeloo = new Body({
    ...
    radius: 600000,
    geeAsl: 0.15,
    atmosphere: atmosphere(80000, 10000),
...
const Nara = new Body({
    ...
    radius: 3600000,
    geeAsl: 1,
    atmosphere: atmosphere(200000, 85000),
    highSpaceAltitude: 1800000,
    rotationalPeriod: 43200,
    orbit: new Orbit({
        parentBody: Kerbol,
